...
from .models import Language, SourceReferences, MotivationTypes, GeoTypes, \
    Maps, GeoSystems, MapsSystems, GeoObjects, GeoNames, Persons
...
class PersonsAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'patronymic', 'last_name', 'comment',)
    search_fields = ['first_name', 'patronymic', 'last_name', 'comment', ]
